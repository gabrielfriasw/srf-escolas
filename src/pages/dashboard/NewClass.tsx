...
export const NewClass: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Converter emails em IDs de usuários
    const teacherIds = teacherEmails.map(email => {
      const teacher = userService.getUserByEmail(email);
      return teacher?.id;
  ...
  const handleAddTeacher = () => {
    ...
    const teacher = userService.getUserByEmail(currentEmail);
    if (!teacher) {
