...
import { Users, LogOut, PlusCircle, Settings, X, Image, LayoutGrid } from 'lucide-react';
  ...
  return (
    <div className="h-screen w-64 bg-black dark:bg-dark-primary text-white p-6 flex flex-col">
      ...
      <nav className="flex-1 space-y-2">
        ...
        {/* Novo menu de Ensalamento */}
        <div className="pt-4 border-t border-gray-800 dark:border-dark-300">
          <span className="px-3 text-sm text-gray-400">Ensalamento</span>
          <button
            onClick={() => handleNavigation('/dashboard/ensalamento')}
            className="w-full flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-800 dark:hover:bg-dark-200 transition-colors mt-2"
          >
